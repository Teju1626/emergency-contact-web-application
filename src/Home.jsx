...
const Home = () => {
  ...
  return (
    <div className="home-container">
      ...
      <p className="welcome-message">"Welcome to Safe Steps, Your Safety is Our Priority! 🚨"</p>
      ...
      <div className="intro-text">
        ...
        <p>At Safe Steps, our mission is to support women by providing a user-friendly and accessible service that adapts to various situations, allowing you to take control of your safety wherever you go. Because your safety is not just a priority, it’s a promise. Stay connected, stay empowered, and let Safe Steps be the guardian that accompanies you anytime, anywhere.</p>
      </div>
